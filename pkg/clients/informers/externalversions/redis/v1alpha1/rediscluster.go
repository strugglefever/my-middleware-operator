...
import (
	...
	v1alpha1 "github.com/wflysnow/my-middleware-operator/pkg/clients/listers/redis/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RedisV1alpha1().RedisClusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RedisV1alpha1().RedisClusters(namespace).Watch(context.TODO(), options)
			},
		},
